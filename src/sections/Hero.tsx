...
export function Hero() {
  return (
    <section id="hero" className="flex justify-center px-6 pt-36 pb-16">
      <div className="hero-card grid w-full max-w-2xl grid-cols-1 items-center gap-8 rounded-[28px] px-10 py-10 md:grid-cols-[1fr_auto]">
        <div className="relative z-10 text-center md:text-left">
          <h1 className="font-display text-5xl leading-tight md:text-6xl">Abdur Sujon</h1>
        ...
        <div className="hero-portrait-frame relative z-10 order-first mx-auto md:order-none md:mx-0">
